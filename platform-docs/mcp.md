...
which drives all 199 tools under two different scope sets and reads the required scope out
...
The server registers **199 tools**. 175 are always present. The remaining 24 are gated to
