...
which drives all 143 tools under two different scope sets and reads the required scope out
...
The server registers **143 tools**. 122 are always present. The remaining 21 are gated to
