...
which drives all 150 tools under two different scope sets and reads the required scope out
...
The server registers **150 tools**. 127 are always present. The remaining 23 are gated to
