...
which drives all 162 tools under two different scope sets and reads the required scope out
...
The server registers **162 tools**. 138 are always present. The remaining 24 are gated to
