...
- `forget_runner_node`: `confirm: "forget_runner_node"`
...
- `delete_agent_task`: `confirm: "delete_agent_task"`
...
- `delete_feedback`: `confirm: "delete_feedback"`
- `delete_agent`: `confirm: "delete_agent"`
- `delete_agent_knowledge`: `confirm: "delete_agent_knowledge"`
- `set_agent_capabilities`: `confirm: "set_agent_capabilities"`
- `set_agent_state`: `confirm: "set_agent_state"`
- `chat_with_my_agent`: `confirm: "chat_with_my_agent"`
- `create_agent_version`: `confirm: "create_agent_version"`
- `rollback_agent_version`: `confirm: "rollback_agent_version"`
- `execute_agent_builder_plan`: `confirm: "execute_agent_builder_plan"`
...
which drives all 236 tools under two different scope sets and reads the required scope out
...
The server registers **236 tools**. 210 are always present. The remaining 26 are gated to
