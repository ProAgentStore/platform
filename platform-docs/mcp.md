...
which drives all 153 tools under two different scope sets and reads the required scope out
...
The server registers **153 tools**. 130 are always present. The remaining 23 are gated to
