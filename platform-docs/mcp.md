...
which drives all 183 tools under two different scope sets and reads the required scope out
...
The server registers **183 tools**. 159 are always present. The remaining 24 are gated to
