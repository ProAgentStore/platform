...
which drives all 166 tools under two different scope sets and reads the required scope out
...
The server registers **166 tools**. 142 are always present. The remaining 24 are gated to
