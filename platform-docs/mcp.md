...
which drives all 154 tools under two different scope sets and reads the required scope out
...
The server registers **154 tools**. 130 are always present. The remaining 24 are gated to
