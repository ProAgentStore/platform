...
which drives all 178 tools under two different scope sets and reads the required scope out
...
The server registers **178 tools**. 154 are always present. The remaining 24 are gated to
