...
which drives all 202 tools under two different scope sets and reads the required scope out
...
The server registers **202 tools**. 178 are always present. The remaining 24 are gated to
