...
which drives all 151 tools under two different scope sets and reads the required scope out
...
The server registers **151 tools**. 128 are always present. The remaining 23 are gated to
