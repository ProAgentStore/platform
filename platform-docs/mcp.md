...
which drives all 205 tools under two different scope sets and reads the required scope out
...
The server registers **205 tools**. 181 are always present. The remaining 24 are gated to
