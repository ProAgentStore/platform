...
which drives all 239 tools under two different scope sets and reads the required scope out
...
The server registers **239 tools**. 213 are always present. The remaining 26 are gated to
