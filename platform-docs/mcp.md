...
which drives all 225 tools under two different scope sets and reads the required scope out
...
The server registers **225 tools**. 199 are always present. The remaining 26 are gated to
