...
which drives all 164 tools under two different scope sets and reads the required scope out
...
The server registers **164 tools**. 140 are always present. The remaining 24 are gated to
