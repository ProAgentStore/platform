...
which drives all 238 tools under two different scope sets and reads the required scope out
...
The server registers **238 tools**. 212 are always present. The remaining 26 are gated to
