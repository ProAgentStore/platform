...
which drives all 159 tools under two different scope sets and reads the required scope out
...
The server registers **159 tools**. 135 are always present. The remaining 24 are gated to
