...
which drives all 168 tools under two different scope sets and reads the required scope out
...
The server registers **168 tools**. 144 are always present. The remaining 24 are gated to
