...
which drives all 203 tools under two different scope sets and reads the required scope out
...
The server registers **203 tools**. 179 are always present. The remaining 24 are gated to
