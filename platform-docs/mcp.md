...
which drives all 171 tools under two different scope sets and reads the required scope out
...
The server registers **171 tools**. 147 are always present. The remaining 24 are gated to
