...
The server currently has 146 tool registrations across `workers/mcp/src`.
...
- MCP exposed its tool set (26 at the time of this 2026-06-11 record; 146 tool registrations in source today — see MCP Tool Groups above).
