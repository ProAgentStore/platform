	...
	const loadAll = useCallback(() => {
		(async () => {
			...
			try {
				...
				// that already knows (#742). It excludes canceled instances while retaining paused
				// siblings, and a paused current row needs to remain available to its Resume card (#826).
