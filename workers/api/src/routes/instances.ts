 ...
 *
 * Paused instances are excluded by default too (#826) — parked, not gone: resuming brings one
 * straight back. Any caller that resolves ONE instance by id/slug or counts what the user has
 * must send `?includePaused=1`, or a paused instance's page reads as missing and Resume is lost.
 */
