...
const ROUTES = [
	...
	"GET /:instanceId/operator-manual",
	"PUT /:instanceId/operator-manual",
	...
	"POST /:instanceId/site-builder/:runId/capture",
	"POST /:instanceId/site-builder/:runId/evidence",
	"GET /:instanceId/site-builder/:runId/artifacts/:artifactId",
...
const GATES: Record<string, [number, number]> = {
	...
	"GET /:instanceId/operator-manual": [401, 404],
	"PUT /:instanceId/operator-manual": [401, 404],
	...
	"POST /:instanceId/site-builder/:runId/capture": [401, 404],
	"POST /:instanceId/site-builder/:runId/evidence": [401, 404],
	"GET /:instanceId/site-builder/:runId/artifacts/:artifactId": [401, 401],
