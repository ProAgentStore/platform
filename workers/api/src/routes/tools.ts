...
/**
 * GET /v1/instances/:id/connectors — every connector, with this instance's verdict on it (#352).
 *
 * `/tools` above already answers this for the eleven connectors that HAVE tools, because a
 * connector belongs to an agent precisely when one of its tools does. The three connected accounts
 * declared in #352 Stage 1 declare `tools: []` on purpose, so they fell through that answer
