 ...
 */
export async function requireUser(c: Context<{ Bindings: Env }>): Promise<SessionPayload> {
...
/** Require 'admin' role. */
export async function requireAdmin(c: Context<{ Bindings: Env }>): Promise<SessionPayload> {
...
export async function requireCreator(c: Context<{ Bindings: Env }>): Promise<SessionPayload> {
  const session = await requireUser(c);
