...
import type { AgentMessage, AgentTask, MemoryEntry, AgentState } from './agent-do.js';
...
describe('AgentDO types', () => {
  ...
  it('AgentTask has valid statuses', () => {
    ...
    const statuses: AgentTask['status'][] = ['pending', 'in_progress', 'blocked', 'complete'];
  ...
  it('MemoryEntry has valid types', () => {
    ...
    const types: MemoryEntry['type'][] = ['identity', 'knowledge', 'preference', 'skill', 'context'];
