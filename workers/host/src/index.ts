 ...
 */
import {
	homepage, aboutPage, getStartedPage, skillsPage, skillMcpOperatorPage, browserRuntimeDocsPage, mcpDocsPage, consolePage, consoleCss, consoleCoreJs, consoleInstancesJs, consoleInstancesAppsJs, consoleAgentDataJs, consoleProfileJs, consoleUtilsInitJs, agentDetailPage,
